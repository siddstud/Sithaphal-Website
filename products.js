            ...
            <div class="product-container text-center transform hover:-translate-y-4 hover:rotate-1 transition-all duration-500 hover:z-10 relative group">
                <div class="product-card relative bg-gradient-to-br ${gradient} rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 border-2 border-white/20">
                    ...
                    <div class="relative overflow-hidden h-64 bg-white/10 backdrop-blur-sm">
                        ...
                        <!-- Wishlist Button -->
                        <button class="wishlist-btn absolute top-4 right-4 p-3 bg-white/90 backdrop-blur-sm rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-red-50 hover:scale-110 z-20">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-700 hover:text-red-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                            </svg>
                        </button>
                        
                        <!-- Quick View Button -->
                        <button class="quick-view-btn absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-sm text-gray-800 px-4 py-2 rounded-full text-sm font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white hover:scale-105 z-20">
                            👁️ Quick View
                        </button>
                    </div>
                    <!-- Content Section -->

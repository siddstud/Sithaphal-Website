...
function addMessage(message, sender) {
    ...
    messageElement.classList.add('chat-message', 'p-3', 'rounded-lg', 'mb-2', 'w-fit');
    if (sender === 'user') {
        messageElement.classList.add('bg-green-100', 'self-end', 'ml-auto');
    } else {
...
function addLoadingIndicator() {
    ...
    loadingElement.classList.add('chat-message', 'p-3', 'rounded-lg', 'mb-2', 'w-fit', 'bg-gray-200', 'self-start', 'mr-auto');

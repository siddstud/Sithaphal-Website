...
function updateOrderSummaryFromCart(cartItems) {
    ...
    if (cartItems.length === 0) {
        // Show default items if cart is empty
        cartItemsContainer.innerHTML = `
            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                <img src="Gemini_Generated_Image_8ssjtg8ssjtg8ssj.png" alt="Sweetest Sithaphal" class="w-16 h-16 object-cover rounded-lg">
                <div class="flex-1">
                    <h4 class="font-medium text-gray-900">Sweetest Sithaphal</h4>
                    <p class="text-sm text-gray-600">Qty: 2</p>
                </div>
                <span class="font-medium text-gray-900">$14.98</span>
            </div>
            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                <img src="Gemini_Generated_Image_jxmzvujxmzvujxmz.png" alt="Family Pack" class="w-16 h-16 object-cover rounded-lg">
                <div class="flex-1">
                    <h4 class="font-medium text-gray-900">Family Pack</h4>
